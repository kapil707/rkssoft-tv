           		...
           		<div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
						<div class="input-daterange input-group" id="datepicker">
							<input type="text" class="form-control" id="startdate" name="startdate" data-date-format="dd-MM-yyyy" autocomplete="off" value="<?= date("d-F-Y"); ?>" placeholder="Start Date" data-mask="<?= date("d-F-Y"); ?>">
						</div>
					</div>
				...
				<div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group clockpicker" data-autoclose="true">
							<input type="text" name="starttime" class="form-control" autocomplete="off" value="<?= date("H:i"); ?>" placeholder="Start Time" data-mask="99:99">

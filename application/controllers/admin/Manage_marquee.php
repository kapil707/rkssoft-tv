...
class Manage_marquee extends CI_Controller {

	var $Page_title = "Manage Marquee";
	var $Page_name  = "manage_marquee";
	var $Page_view  = "manage_marquee";
	var $Page_menu  = "manage_marquee";
	var $page_controllers = "manage_marquee";
	var $Page_tbl   = "tbl_marquee";
	...
	public function edit($id)
	{
		...
		if(isset($Submit))
		{
			...
			$marqee_text 	= base64_encode($marqee_text);

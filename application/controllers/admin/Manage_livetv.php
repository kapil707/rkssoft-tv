...
class Manage_livetv extends CI_Controller {

	var $Page_title = "Manage livetv";
	var $Page_name  = "manage_livetv";
	var $Page_view  = "manage_livetv";
	var $Page_menu  = "manage_livetv";
	var $page_controllers = "manage_livetv";
	var $Page_tbl   = "tbl_livetv_new";

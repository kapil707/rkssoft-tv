...
class Manage_videoads extends CI_Controller {

	var $Page_title = "Video Ads";
	var $Page_name  = "manage_videoads";
	var $Page_view  = "manage_videoads";
	var $Page_menu  = "manage_videoads";
	var $page_controllers = "manage_videoads";
	...
	public function view()
	{
		...
		$query = $this->db->query("select * from $tbl where page_type='VideoAds' order by id desc");

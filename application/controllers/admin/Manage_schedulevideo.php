...
class Manage_schedulevideo extends CI_Controller {

	var $Page_title = "Schedule Video";
	var $Page_name  = "manage_schedulevideo";
	var $Page_view  = "manage_schedulevideo";
	var $Page_menu  = "manage_schedulevideo";
	var $page_controllers = "manage_schedulevideo";
	...
	public function add()
	{
		...
		$data['dir'] = $dir = 'G:/sky/schedulevideo/';
		$display = 1;
		extract($_POST);
		if(isset($Submit))
		{
	...
	public function view()
	{
		...
		$query = $this->db->query("select * from $tbl where page_type='SchedulingVideo' order by id desc");
